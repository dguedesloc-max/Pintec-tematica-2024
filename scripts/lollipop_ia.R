...
# ---------------------------------------------------------------------
# IA: los dos pares centrales para los objetivos (iii) y (iv)
# ---------------------------------------------------------------------

g_ia_admin_producao <- grafico_lollipop("IA", "admin_producao")
g_ia_projeto_producao <- grafico_lollipop("IA", "projeto_producao")

print(g_ia_admin_producao)
print(g_ia_projeto_producao)

dir.create(here("output"), showWarnings = FALSE)
ggsave(here("output", "lollipop_IA_admin_producao.png"), g_ia_admin_producao, width = 7, height = 7, dpi = 300)
ggsave(here("output", "lollipop_IA_projeto_producao.png"), g_ia_projeto_producao, width = 7, height = 7, dpi = 300)